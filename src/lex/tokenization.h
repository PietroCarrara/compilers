...
#define TOKEN_FLOAT  KW_FLOAT
#define TOKEN_CODE   KW_CODE
#define TOKEN_IF     KW_IF
#define TOKEN_ELSE   KW_ELSE
#define TOKEN_WHILE  KW_WHILE
#define TOKEN_INPUT  KW_INPUT
#define TOKEN_PRINT  KW_PRINT
